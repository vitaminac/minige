...
/*! @brief Returns the title of the specified monitor.
 *
 *  This function returns a human-readable title, encoded as UTF-8, of the
 *  specified monitor.  The title typically reflects the make and model of the
 *  monitor and is not guaranteed to be unique among the connected monitors.
 *
 *  @param[in] monitor The monitor to query.
 *  @return The UTF-8 encoded title of the monitor, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
...
/*! @brief Returns the localized title of the specified printable key.
 *
 *  This function returns the localized title of the specified printable key.
 ...
 *  @return The localized title of the key, or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 *
...
/*! @brief Returns the title of the specified joystick.
 *
 *  This function returns the title, encoded as UTF-8, of the specified joystick.
 ...
 *
 *  @param[in] joy The [joystick](@ref joysticks) to query.
 *  @return The UTF-8 encoded title of the joystick, or `NULL` if the joystick
 ...
 *
 *  @param[in] extension The ASCII encoded title of the extension.
 ...
 *
 *  @param[in] procname The ASCII encoded title of the function.
